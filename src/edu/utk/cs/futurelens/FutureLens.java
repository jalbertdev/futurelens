...
package edu.utk.cs.futurelens;

import edu.utk.cs.futurelens.data.LicenseFunctions;
import edu.utk.cs.futurelens.ui.FLInterface;

public class FutureLens 
{
	...
	{
		try {
			if(true){ //LicenseFunctions.verifyHash()
				new FLInterface().loadInterface();
				}
		} catch (Exception e) {
			e.printStackTrace();
		}
